...
function normalizeConfirmedInvoiceNumber(value) {
  ...
  throw new Error('インボイス登録番号は T + 13桁の数字、または13桁の数字で入力してください。');
}
...
function submitConfirmedReceiptFromWebApp(data) {
  ...
  const result = {
    ...
    invoiceNumber: normalizeConfirmedInvoiceNumber(confirmed.invoiceNumber),
